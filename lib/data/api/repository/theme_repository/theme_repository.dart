import 'dart:convert';
import 'package:portfolio_app/data/model/theme/theme.dart';
import 'package:portfolio_app/data/api/main_fetcher.dart' as fetcher;
import '../../base_repository.dart';

class ThemeRepository extends BaseRepository with fetcher.MainFetcher {
  static String ressource = 'themes';

  @override
  Future fetchAll(
      {String? params, Map<String, String>? headers, bool? toJsonLd}) async {
    var response = await get(url: '$ressource$params', toJsonLd: toJsonLd);
    return Theme.listFromJson(json.decode(response.content));
  }
  ...
  Future fetchOne(
    ...
    return Theme.fromMap(json.decode(response.content));
  }
  ...
  Future<Theme> insert(
    ...
    var response = await post(
        url: '$ressource', body: jsonEncode((body as Theme).toJson()));
    return Theme.fromMap(json.decode(response.content));
  }
  ...
  Future update(
    ...
    var response = await put(
        url: '$ressource/${(body as Theme).id}',
